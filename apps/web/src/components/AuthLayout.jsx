    ...
    <div className="min-h-screen flex bg-[hsl(220_15%_5%)]">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-10 right-10">
          ...
          <button className="mt-4 text-xs tracking-widest text-primary uppercase flex items-center gap-2 hover:gap-3 transition-all">
      ...
      <div
        className="w-full lg:w-[500px] flex items-center justify-center px-10 py-12"
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex flex-col items-center mb-8">
            <div
              ...
              style={{
                filter:
                  'drop-shadow(0 0 18px rgba(74,222,128,0.25)) drop-shadow(0 0 40px rgba(74,222,128,0.1))',
              }}
            >
              <img
                src="/images/LOGO.png"
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                '0 0 40px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.05)',
            }}
          >
            {children}
          </div>
